    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @if (in_array(4, $permissions))
                <a href="{{ route('employeesWithPermissions.index') }}" class="btn btn-primary">Back to Employee List</a>
            @endif
        ...
        <div>
            <form action="{{ route('employeesWithPermissions.update', $employee->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="notes" class="form-control" rows="4">{{ $employee->notes }}</textarea>
                </div>
                <div class="form-group mb-3">
